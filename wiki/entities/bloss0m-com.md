...
type: Entity
title: "bloss0m.com"
description: "bloss0m.com 為對外 Agent 作品集；目標每日一篇技術前沿 blog，支撐年底轉職敘事。"
tags: ["作品集", "agent", "rag", "blog"]
...
**https://bloss0m.com/** 為個人對外 **Agentic AI 工程師** 作品集與文章站。（確定）[2026-06-03-年底轉職與時間配置](/sources/2026-06-03-年底轉職與時間配置.md)

自 **2026-06-25** 起新增目標：**每日一篇** [每日技術前沿-blog](/concepts/每日技術前沿-blog.md)；素材可來自 [每日資訊收集-agent](/concepts/每日資訊收集-agent.md)、Kaggle／金融 Agent 實作、論文深讀。（確定）[2026-06-25-學習與-side-主軸調整](/sources/2026-06-25-學習與-side-主軸調整.md)
...
- 每日發文工作流（git push、CMS、agent 草稿）？（未知）
